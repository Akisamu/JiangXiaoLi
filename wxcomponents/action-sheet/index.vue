<template>
<uni-shadow-root class="action-sheet-index"><van-popup :show="show" position="bottom" :z-index="zIndex" :overlay="overlay" custom-class="van-action-sheet" :close-on-click-overlay="closeOnClickOverlay" @close="onClose">
