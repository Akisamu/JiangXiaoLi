<template>
<uni-shadow-root class="badge-group-index"><view class="van-badge-group van-hairline--top-bottom custom-class">
  <slot></slot>
...
global['__wxRoute'] = 'badge-group/index'
...
export default global['__wxComponents']['badge-group/index']
</script>
