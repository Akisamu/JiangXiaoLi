<template>
<uni-shadow-root class="cell-index"><view :class="cellClass" :style="customStyle" @click="onClick">
  ...
  <van-icon v-if="isLink" name="arrow" :class="iconWrapClass" custom-class="van-cell__right-icon"></van-icon>
