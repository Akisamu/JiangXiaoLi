<template>
<uni-shadow-root class="icon-index"><view :class="'custom-class '+(classPrefix)+' '+(classPrefix)+'-'+(name)" :style="(color ? 'color: ' + color + ';' : '')+(size ? 'font-size: ' + size + ';' : '')+(customStyle)" @click="onClick">
