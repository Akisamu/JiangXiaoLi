<template>
<uni-shadow-root class="notice-bar-index"><view v-if="show" :class="'custom-class van-notice-bar '+(hasRightIcon ? 'van-notice-bar--within-icon' : '')" :style="'color: '+(color)+';background-color: '+(backgroundColor)" @click="onClick">
  ...
  <block v-if="mode">
    <van-icon v-if="mode === 'closeable'" class="van-notice-bar__right-icon" name="close" @click.native="onClickIcon"></van-icon>
